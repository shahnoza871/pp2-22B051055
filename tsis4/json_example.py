...
print(type(things))
str_things = json.dumps(things)
print(json.loads(str_things))
...
print(type(human_json), human_json)

human_back = json.loads(human_json)
print(type(human_back), human_back)"""